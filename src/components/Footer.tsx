    ...
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-secondary-foreground/70 text-sm leading-relaxed">
            Handcrafted sacred idols blessed by priests, delivered to your
            doorstep with divine care.
          </p>
        </div>
        <div>
          ...
          <div className="space-y-2">
            <Link
              to="/"
              className="block text-sm text-secondary-foreground/70 hover:text-gold transition-colors"
            >
              Home
            </Link>
            <Link
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <a
              href="mailto:admin.mipar@gmail.com"
              className="flex items-center gap-2 text-sm text-secondary-foreground/70 hover:text-gold transition-colors"
            >
      ...
      <div className="border-t border-secondary-foreground/10 mt-8 pt-6 text-center">
        <p className="text-sm text-secondary-foreground/50">
          © {new Date().getFullYear()} MIPAR Sacred Idols. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
